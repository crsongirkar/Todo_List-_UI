package com.chinmaysapplication.app.modules.profilechangepassword.`data`.model

import com.chinmaysapplication.app.R
import com.chinmaysapplication.app.appcomponents.di.MyApp
import kotlin.String

data class ProfileChangePasswordModel(
  /**
  ...
  var txtChangeaccountThree: String? =
      MyApp.getInstance().resources.getString(R.string.msg_change_account4)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtEnteroldpassw: String? =
      MyApp.getInstance().resources.getString(R.string.msg_enter_old_passw)
  ,
  /**
   * TODO Replace with dynamic value
   */
